void histo(TString inputDir = "output", Int_t NTHR = 7)
{
    for (Int_t THR = 1; THR <= NTHR; THR++) {
        ...
        TBranch* Br = tree->GetBranch("HEROdetectorvCubPoint");      //For work whith Spherical detector. you needed to change to HEROdetectorvSpherePoint
        if (!Br)
        {
